...
import img8 from "./assets/Airport.png";
      ...
      <div className="flex flex-wrap items-center" id="Home">
        ...
        <div className="w-full md:w-1/2 p-4">
          ...
          <p className="text-lg mt-4 border-b-red-400">
            I am a motivated and passionate frontend developer specializing in
            React.js. As a recent graduate, I bring a fresh perspective and a
            keen interest in building dynamic and responsive web applications.
            My foundational knowledge in HTML5, CSS3, and JavaScript, combined
            with hands-on experience in React.js, enables me to create engaging
            user interfaces and improve overall user experience.
          </p>
        </div>
          ...
          <div className="flex flex-wrap justify-center -mx-4">
            ...
            <div className="w-full md:w-1/3 px-4 mb-8">
              <div className="block max-w-sm p-6 bg-white border border-gray-200 rounded-lg shadow hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700">
                ...
                />
                <div className="p-6">
                  <h3 className="text-xl font-bold mb-2">AirFare Calculator</h3>
                  <p className="text-gray-700 mb-4 text-justify">
                    Developed a comprehensive web-based application, "AirFare
                    Calculator," designed to provide users with a detailed
                  ...
                  <a
                    href="https://github.com/Ranjithreddyyy/Airport-App"
            ...
            <div className="w-full md:w-1/3 px-4 mb-8">
              <div className="block max-w-sm p-6 bg-white border border-gray-200 rounded-lg shadow hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700">
                ...
                <div className="p-6">
                  ...
                  <p className="text-gray-700 mb-4 text-justify">
                    Implemented the core logic for performing arithmetic
                    operations using JavaScript. Designed a user-friendly
                    interface with HTML and styled it with CSS for a modern and
                    intuitive user experience.
                  </p>
                  <a
                    href="https://github.com/Ranjithreddyyy/Calculator"
                    className="text-blue-500 hover:underline"
                  >
                    Github
                  </a>
              ...
              <div className="block max-w-sm p-6 bg-white border border-gray-200 rounded-lg shadow hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700">
                ...
                <div className="p-6">
                  ...
                  <p className="text-gray-700 mb-4 text-justify">
                    ...
                    functionality for managing tasks, allowing users to add,
                    edit, delete, and mark tasks as completed. Utilized modern
                    web technologies such as HTML5, CSS3, and JavaScript to
                    create a dynamic and interactive user interface.
                  </p>
                  <a
                    href="https://github.com/Ranjithreddyyy/To-Do-Project"
                    className="text-blue-500 hover:underline"
                  >
                    Github
                  </a>
